...
import 'package:baca_app/A_newstructure/features/admin/admin_home/view/components/admin_notification_card.dart';
import 'package:baca_app/A_newstructure/features/admin/admin_home/view/components/admin_quick_action.dart';
import 'package:baca_app/A_newstructure/features/admin/admin_home/view/components/top_stats_card.dart';
...
class AdminHomeView extends GetView<AdminHomeController> {
  ...
  Widget build(BuildContext context) {
    ...
    final topStatsC = Get.find<AdminTopStatsController>();
    return Scaffold(
