import 'package:baca_app/A_newstructure/features/user/user_book_borrow_detail/view/components/bottom_nav_review.dart';
import 'package:baca_app/A_newstructure/features/user/user_book_borrow_detail/view/components/bottom_nav_scan.dart';
import 'package:baca_app/A_newstructure/features/user/user_book_borrow_detail/view/components/user_body_on_borrow.dart';
import 'package:baca_app/A_newstructure/features/user/user_book_borrow_detail/view/components/user_body_pending.dart';
import 'package:baca_app/A_newstructure/features/user/user_book_borrow_detail/view/components/user_body_rejected.dart';
import 'package:baca_app/A_newstructure/features/user/user_book_borrow_detail/view/components/user_body_returned.dart';
...
class UserBookBorrowDetailView extends StatelessWidget {
  const UserBookBorrowDetailView({super.key});

  @override
  Widget build(BuildContext context) {
    final arguments = Get.arguments;
    final borrow = arguments["borrow"] as BorrowModel;
      ...
      body: Column(
        children: [
          ...
          status == Status.pending
              ...
              : status == Status.rejected
              ? UserBodyRejected(status: status, borrow: borrow)
              : Container(),
        ],
      ),
