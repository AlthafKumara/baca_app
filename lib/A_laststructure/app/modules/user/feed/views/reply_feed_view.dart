...
import 'package:baca_app/A_laststructure/app/modules/user/feed/widget/chip_you.dart';
import 'package:baca_app/A_laststructure/app/modules/user/feed/widget/feed_single_book_card.dart';
import 'package:baca_app/A_laststructure/app/modules/user/feed/widget/form_feed_bottom_nav.dart';
...
class ReplyFeedView extends GetView {
  ...
  final profile = Get.arguments["profile"] as Profile;
  final community = Get.arguments["community"] as Community;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: FormFeedBottomNav(
        onTapUpload: () {
          formC.handleReplyFeed(communityId: community.id);
        },
        uploadText: "Reply",
      ),
    );
