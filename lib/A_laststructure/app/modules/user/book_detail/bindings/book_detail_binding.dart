...
import 'package:baca_app/A_laststructure/app/modules/user/book_detail/controllers/saved_list_controller.dart';
...
class BookDetailBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut<GetReviewController>(() => GetReviewController());
  }
}
