...
import 'package:baca_app/A_laststructure/app/modules/admin/admin_profile/controllers/admin_profile_controller.dart';
            ...
            GestureDetector(
              onTap: () {
                if (profile != null) {
                  ...
                  CustomSnackbar.failedSnackbar("Profile not found");
                }
              },
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
