...
class AdminReviewContainer extends StatelessWidget {
  final int bookId;
  final reviewC = Get.find<AdminGetReviewcontroller>();
  AdminReviewContainer({super.key, required this.bookId});
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text.rich(
                TextSpan(
                  text: reviewC.listreview.length.toString(),
            ...
            (state) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  if (state[index].profile == null) {
                    return SizedBox(
                      height: 100.h,
                      child: Text("Profile not load"),
                    );
                  }
