...
class AdminSearchBookCard extends StatelessWidget {
  final Book book;
  const AdminSearchBookCard({super.key, required this.book});

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Get.toNamed(Routes.ADMIN_DETAIL_BOOK, arguments: book),
      child: Container(
